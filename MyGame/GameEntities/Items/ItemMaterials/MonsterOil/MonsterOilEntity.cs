...
{
    public class MonsterOilEntity:Entity
    {
        int count;
        public MonsterOilEntity(int count = 1) : base("monsterOilEntity")
        {
            this.count = count;
            this.setScale(0.5f);
        }
        ...
        {
            base.onAddedToScene();
            var texture = scene.content.Load<Texture2D>("Images/ItemsIcon/I_Coal");
        ...
        private bool Body_onCollision(Fixture fixtureA,Fixture fixtureB,Contact contact)
        {
            ...
            if (picker != null)
            {
                picker.pickUp(new MonsterOil(), this.count);
                this.destroy();
            }
            return true;
        }
